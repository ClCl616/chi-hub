...
export default function DashboardPage() {
  return <AppShell>
    <div className="page-heading"><div><p className="eyebrow">{today}</p><h1>오늘도, 나답게.</h1><p className="page-description">하루의 리듬을 한곳에서 가볍게 확인하세요.</p></div><Link className="primary-button" href="/notes">빠른 기록 <ArrowUpRight size={17}/></Link></div>
    <section className="dashboard-grid" aria-label="오늘의 요약">
      <article className="focus-card"><div className="card-label"><TimerReset size={17}/> 집중</div><div className="timer-value">25:00</div><p>첫 번째 집중 세션을 시작해볼까요?</p><Link className="timer-button" href="/focus">집중 시작</Link></article>
